...
def read_args():
    ...
    parser.add_argument('--dataset_path_train', type=str, default='telco/WA_Fn-UseC_-Telco-Customer-Churn__train.csv',
                        help='Path to the file containing the training set.')
    parser.add_argument('--dataset_path_test', type=str, default='telco/WA_Fn-UseC_-Telco-Customer-Churn__test.csv',
